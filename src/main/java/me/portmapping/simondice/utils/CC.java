...
public class CC {
    ...
    public static final String B_PRIMARY = PRIMARY+B;
    public static final String SECONDARY = ChatColor.DARK_AQUA.toString();
    public static final String B_SECONDARY = SECONDARY+B;
